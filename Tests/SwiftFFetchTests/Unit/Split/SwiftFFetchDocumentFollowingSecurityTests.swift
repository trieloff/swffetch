//
//  SwiftFFetchDocumentFollowingSecurityTests.swift
//  SwiftFFetchTests
//
//  Security-specific tests for document following functionality in FFetch.
//
import XCTest
import SwiftSoup
@testable import SwiftFFetch

final class DocumentFollowingSecurityTests: XCTestCase {
